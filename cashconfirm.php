...
include('config.php');
$transactioncode = $_POST['transactioncode'];
$result = mysqli_query($bd, "SELECT * FROM orderdetails where transactioncode = '$transactioncode'");
...
include('config.php');
$transactioncode = $_POST['transactioncode'];
$result = mysqli_query($bd, "SELECT sum(total) FROM orderdetails where transactioncode = '$transactioncode'");
while ($row1 = mysqli_fetch_array($result)) {
    echo $row1['sum(total)'];
}
?>
